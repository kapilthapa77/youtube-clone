...
import beast from './images/mrbeast.png'
    ...
    return (
        <div class="thumbnail">
            ...
            <div class="video-title">
                <div>
                    <img src={kapil} height={'30px'} width={'30px'} class="kapil"></img>
                </div>
        ...
        <div>
            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        <img src={beast} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">Mr Beast</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={tmkoc} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">TMKOC</span>
                    </button>
                </div>
